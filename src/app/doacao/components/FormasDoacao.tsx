...
export default function FormasDoacao() {
  ...
  //Mudar o background ao clicar no botão
  const [selectedCartao, setSelectedCartao] = useState(false);
  const [selectedBoleto, setSelectedBoleto] = useState(false);
  const [selectedPix, setSelectedPix] = useState(false);

  function handleCartaoClick() {
    setSelectedCartao(true);
    ...
    <div className={style.formasContainer}>
      ...
      <div className={style.formasDoacao}>
        <div className={style.forma}>
          <button className={`${style.svg} ${selectedCartao ? style.selectedFormaButton : ''}`}
            onClick={() => {
              handleClick();
              handleCartaoClick();
            }}>
        ...
        <div className={style.forma}>
          <button className={`${style.svg} ${selectedBoleto ? style.selectedFormaButton : ''}`}
            onClick={() => {
              handleClick();
              handleBoletoClick();
            }}>
        ...
        <div className={style.forma}>
          <button className={`${style.svg} ${selectedPix ? style.selectedFormaButton : ''}`}
            onClick={() => {
              handleClickPix();
              handlePixClick();
            }}>
